...
public class AVOMath 
{
    ...
    {
        return (det(a.subtract(c), b.subtract(a))>0);
    }
	...
	{
		return (leftOf(vo.apex, vo.side1, c)&& rightOf(vo.apex, vo.side2, c));
	}
	
	public static boolean inSector(Sector s, Double2D c)
	{
		return (leftOf(s.apex, s.side1, c)&& rightOf(s.apex, s.side2, c)&& inCircle(s.apex,s.r,c));
	}
